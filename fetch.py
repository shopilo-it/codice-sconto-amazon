#!/usr/bin/env python3
"""
Fetch coduri de reducere Amazon de pe shopilo.it
Sursa: https://shopilo.it/magazin/amazon.it
"""
...
SHOPILO_URL = "https://shopilo.it/magazin/amazon.it"
STORE_NAME = "Amazon"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Amazon de pe shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-amazon)"
    }
    try:
