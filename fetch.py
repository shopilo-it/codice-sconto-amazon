#!/usr/bin/env python3
"""
Recupero codici sconto Amazon da shopilo.it
Sursa: https://shopilo.it/negozi/amazon.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/amazon.it"
STORE_NAME = "Amazon"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Amazon da shopilo.it"""
    headers = {
